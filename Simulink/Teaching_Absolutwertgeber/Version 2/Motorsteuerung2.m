classdef Motorsteuerung2 < matlab.System
    ...
    methods(Access = protected)
        function setupImpl(obj)
            ...
            obj.schiene_zaehler = 0;
            obj.schiene_zaehler_set = 0;
            obj.schiene_zaehler_sleep = 0;
            
        end
        
        function [n_Motor,Abswertgeber_Set] = stepImpl(obj,Schritt1,Taster_Schiene,Clock)
            % Implement algorithm. Calculate y as a function of input u and
            % discrete states.
            
            % Zähler für Taster
            if(Taster_Schiene > 0.35) && (obj.schiene_zaehler_set == 0) && ((Clock - obj.schiene_zaehler_sleep) > 1)
                obj.schiene_zaehler = obj.schiene_zaehler + 1;
                obj.schiene_zaehler_set = 1;
                obj.schiene_zaehler_sleep = Clock;
            end
            if(Taster_Schiene < 0.35)
                obj.schiene_zaehler_set = 0;
            end
            ...
            if(obj.schiene_zaehler == 2) && (obj.Schritt2 == 1) && (obj.Schritt3 == 0) % Ende erreicht
                ...
                if((Clock - obj.time1) >= 2) %%% von 1 auf 2 geändert
            ...
            if((Clock - obj.time1) >= 6) && (obj.Schritt3 == 1) && (obj.Schritt4 == 0) %%% von 4 auf 6 geändert
                obj.prop_n_Motor = 0.05;
                
                obj.Schritt4 = 1; % Einstellungen für Schritt 4 abgeschlossen
            end
            
            if(obj.schiene_zaehler == 4) && (obj.Schritt4 == 1) && (obj.Schritt5 == 0)
