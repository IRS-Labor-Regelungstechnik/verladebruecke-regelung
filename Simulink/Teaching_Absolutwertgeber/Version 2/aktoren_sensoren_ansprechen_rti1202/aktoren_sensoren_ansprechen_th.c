/************************ dSPACE target specific file *************************
   ...
   Include file .\aktoren_sensoren_ansprechen_rti1202\aktoren_sensoren_ansprechen_th.c :

   Task Configuration file for model : aktoren_sensoren_ansprechen

   RTI1202 7.7 (02-Nov-2016)/2.17
   27-Nov-2020 12:55:47
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\aktoren_sensoren_ansprechen_rti1202\aktoren_sensoren_ansprechen_th.c is for ST).
# endif
