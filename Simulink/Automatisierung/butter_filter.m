...
[angle_butter.num, angle_butter.denom] = butter(order, 2*pi*1, 's');

order = 2;
[weg_butter.num, weg_butter.denom] = butter(order, 2*pi*0.5, 's');
...
[weg_butter.tf_1p0_num, weg_butter.tf_1p0_denom] = butter(order, 2*pi*1.0, 's');
