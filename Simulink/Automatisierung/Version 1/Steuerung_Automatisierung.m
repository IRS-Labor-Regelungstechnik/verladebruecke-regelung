    ...
    methods(Access = protected)
        ...
        function setupImpl(obj)
            ...
            obj.box_x_pos = (obj.box_sequence - 1) * obj.distance_between_boxes ...
                ...
                - obj.box_width/2;
            obj.box_y_pos = ones(size(obj.box_x_pos)) * obj.box_height;
        ...
        function [horiz_setpoint, vert_setpoint, magnet_on, do_horiz_teach, do_vert_teach, do_positioning, control_enable] = ... 
                stepImpl(obj, horiz_value, horiz_speed, vert_value, vert_speed, angle_speed, horiz_teach_finished, vert_teach_finished, positioning_finished)
            ...
            if (obj.is_initializing) 
                ...
                if obj.box_nr <= size(obj.box_x_pos)
                    if obj.magnet_on
