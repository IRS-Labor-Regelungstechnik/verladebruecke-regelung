...
MAKECMD         = /Applications/MATLAB_R2020a.app/bin/maci64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = laufkatze_motor
MODULES                 = rt_logging.c laufkatze_motor.c laufkatze_motor_capi.c laufkatze_motor_data.c laufkatze_motor_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = laufkatze_motor
MAKEFILE                = laufkatze_motor.mk
MATLAB_ROOT             = /Applications/MATLAB_R2020a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2020a.app
MASTER_ANCHOR_DIR       = 
START_DIR               = /Users/Andy/Nextcloud/KIT/LR/verladebruecke-regelung
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
COMPUTER                = MACI64
BUILDARGS               =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/Applications/MATLAB_R2020a.app" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.9"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/laufkatze_motor \
...
rtiostream_utils.o : /Applications/MATLAB_R2020a.app/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) /Applications/MATLAB_R2020a.app/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
