...
#include "laufkatze_motor_capi_host.h"
...
"laufkatze_motor/Unit Conversion" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 ,
0 } , { 0 , 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 } } ; static const
rtwCAPI_BlockParameters rtBlockParameters [ ] = { { 1 , TARGET_STRING (
"laufkatze_motor/MahBoy" ) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 2 ,
TARGET_STRING ( "laufkatze_motor/Gain" ) , TARGET_STRING ( "Gain" ) , 0 , 0 ,
0 } , { 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 } } ; static const
rtwCAPI_ModelParameters rtModelParameters [ ] = { { 0 , ( NULL ) , 0 , 0 , 0
} } ;
#ifndef HOST_CAPI_BUILD
static void * rtDataAddrMap [ ] = { & rtB . ihtgutfncc , & rtP . MahBoy_Value
...
, 0 , ( NULL ) , 0 } , { rtBlockParameters , 2 , rtModelParameters , 0 } , {
( NULL ) , 0 } , { rtDataTypeMap , rtDimensionMap , rtFixPtMap , rtElementMap
, rtSampleTimeMap , rtDimensionArray } , "float" , { 740362845U , 1335057032U
, 2032125424U , 3459786155U } , ( NULL ) , 0 , 0 } ; const
rtwCAPI_ModelMappingStaticInfo * laufkatze_motor_GetCAPIStaticMap ( void ) {
return & mmiStatic ; }
#ifndef HOST_CAPI_BUILD
void laufkatze_motor_InitializeDataMapInfo ( void ) { rtwCAPI_SetVersion ( (
